...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget_5->setGeometry(QRect(0, 10, 951, 531));
...
""));
        ...
        affichageemployee->setGeometry(QRect(390, 360, 171, 23));
...
"}\n"
""));
        nom = new QCheckBox(groupBox_21);
        nom->setObjectName(QString::fromUtf8("nom"));
        nom->setGeometry(QRect(360, 60, 70, 17));
        prenom = new QCheckBox(groupBox_21);
        prenom->setObjectName(QString::fromUtf8("prenom"));
        prenom->setGeometry(QRect(260, 60, 70, 17));
        cin = new QCheckBox(groupBox_21);
        cin->setObjectName(QString::fromUtf8("cin"));
        cin->setGeometry(QRect(160, 60, 70, 17));
        rechercheemployee = new QLineEdit(groupBox_21);
        rechercheemployee->setObjectName(QString::fromUtf8("rechercheemployee"));
        rechercheemployee->setGeometry(QRect(550, 60, 113, 20));
        trouver = new QPushButton(groupBox_21);
        trouver->setObjectName(QString::fromUtf8("trouver"));
        trouver->setGeometry(QRect(710, 60, 75, 23));
...
""));
        ...
        id_reclam_2 = new QLineEdit(groupBox_22);
        id_reclam_2->setObjectName(QString::fromUtf8("id_reclam_2"));
        id_reclam_2->setGeometry(QRect(940, 220, 161, 20));
        id_reclam_2->setStyleSheet(QString::fromUtf8("border: 2px solid black;\n"
"border-radius: 10px;\n"
"padding: 0 8px;\n"
"background: white;\n"
"selection-background-color: gray;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        trouver->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
