/*#include "statistique_f.h"
#include "ui_statistique_f.h"
#include <QtSql>
#include<QMap>
#include <iostream>
#include <QString>
...
statistique_f::statistique_f(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::statistique_f)
{
    ui->setupUi(this);
    // set dark background gradient:
             ...
             regen->setName("nombre de contract");
             ...
             ticks << 1 << 2 << 3 << 4 << 5 ;
             QSqlQuery q;
         q.prepare("select id_frnseur ,AVG(note) from noterf group by id_frnseur  ");
            ...
            regenData   << q.value(1).toDouble();
             ...
             ui->widget->xAxis->setLabel("id_frnseur");
