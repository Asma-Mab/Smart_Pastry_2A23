...
"}"));
        ...
        groupBox_2->setGeometry(QRect(60, 40, 691, 411));
        nom_line = new QLineEdit(groupBox_2);
        nom_line->setObjectName(QString::fromUtf8("nom_line"));
        nom_line->setGeometry(QRect(70, 60, 113, 22));
        prix_l = new QLineEdit(groupBox_2);
        prix_l->setObjectName(QString::fromUtf8("prix_l"));
        prix_l->setGeometry(QRect(70, 120, 113, 22));
        marque_l = new QLineEdit(groupBox_2);
        marque_l->setObjectName(QString::fromUtf8("marque_l"));
        marque_l->setGeometry(QRect(50, 200, 113, 22));
        caracteristique_l = new QLineEdit(groupBox_2);
        caracteristique_l->setObjectName(QString::fromUtf8("caracteristique_l"));
        caracteristique_l->setGeometry(QRect(60, 290, 113, 22));
        etat_l = new QLineEdit(groupBox_2);
        etat_l->setObjectName(QString::fromUtf8("etat_l"));
        etat_l->setGeometry(QRect(320, 250, 113, 22));
        date_l = new QDateEdit(groupBox_2);
        date_l->setObjectName(QString::fromUtf8("date_l"));
        date_l->setGeometry(QRect(350, 100, 110, 22));
        aj = new QPushButton(groupBox_2);
        aj->setObjectName(QString::fromUtf8("aj"));
        aj->setGeometry(QRect(370, 360, 93, 28));
        id_line = new QLineEdit(groupBox_2);
        id_line->setObjectName(QString::fromUtf8("id_line"));
        id_line->setGeometry(QRect(80, 20, 113, 22));
        tabWidget_2->addTab(tab_4, QString());
        tab_5 = new QWidget();
        tab_5->setObjectName(QString::fromUtf8("tab_5"));
        tableView = new QTableView(tab_5);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(50, 60, 771, 381));
...
"}"));
        ...
        stackedWidget->addWidget(Evaluation);
...
""));
        ...
        button_recette_2 = new QPushButton(centralwidget);
        button_recette_2->setObjectName(QString::fromUtf8("button_recette_2"));
        button_recette_2->setGeometry(QRect(0, 538, 247, 51));
        button_recette_2->setStyleSheet(QString::fromUtf8("QPushButton{\n"
"    color:white;\n"
...
"border-radius:10px;\n"
"}"));
        button_recette_2->setIcon(icon7);
        button_recette_2->setIconSize(QSize(40, 40));
    ...
    void retranslateUi(QMainWindow *accueil)
    {
        ...
        button_recette_2->setText(QCoreApplication::translate("accueil", "Evaluation/Reclamation", nullptr));
    } // retranslateUi
